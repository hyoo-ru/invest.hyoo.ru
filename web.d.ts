...
declare namespace $ {
    class $hyoo_invest_stock extends $mol_store<{
        ...
        enter_date(next?: $mol_time_moment): $mol_time_moment;
        exit_date(next?: $mol_time_moment): $mol_time_moment;
        enter_amount(next?: number): number;
        exit_amount(next?: number | null): number;
        rate_annual(next?: number | null): number;
...
declare namespace $ {
    class $hyoo_invest_store extends $mol_store<{
        ...
        stocks(): $hyoo_invest_stock[];
        stock(index: number): $hyoo_invest_stock;
        enter_amount(): number;
        exit_amount(): number;
        rate_annual(): number;
        stock_drop(index: number): void;
    }
}
...
declare namespace $ {
    class $hyoo_invest_labeler extends $mol_labeler {
        attr(): {
            hyoo_invest_labeler_mood: string;
        };
        mood(): string;
    }
}
...
declare namespace $ {
    class $hyoo_invest_stock_row extends $mol_row {
        ...
        Metrics(): $hyoo_invest_stock_row_group;
    }
...
declare namespace $.$$ {
    class $hyoo_invest_stock_row extends $.$hyoo_invest_stock_row {
        ...
        enter_amount(next?: number): number;
        enter_date(next?: $mol_time_moment): $mol_time_moment;
        exit_amount(next?: number): number;
        exit_date(next?: $mol_time_moment): $mol_time_moment;
        income(): number;
        duration(): number;
        rate_annual(next?: number): number;
        exit_date_mood(): "good" | "bad";
        result_mood(): "good" | "bad";
    }
}
...
declare namespace $ {
    class $hyoo_invest extends $mol_page {
        ...
        stock_list(): readonly any[];
        stock_rows(): readonly any[];
        Stock_list(): $$.$mol_list;
        stock(id: any): $hyoo_invest_stock;
        stock_drop(id: any, event?: any): any;
        Stock_drop_icon(id: any): $mol_icon_cross;
...
declare namespace $.$$ {
    class $hyoo_invest extends $.$hyoo_invest {
        stock_list(): $hyoo_invest_stock_row[];
        stock_rows(): $hyoo_invest_stock_row[];
        store(): $hyoo_invest_store;
        stock(id: number): $hyoo_invest_stock;
        enter_amount(): number;
        exit_amount(): number;
        enter_date(): string;
        exit_date(): string;
        rate_annual(): number;
        stock_row_tools(id: number): $mol_button_minor[];
        stock_drop(id: number): void;
    }
}
