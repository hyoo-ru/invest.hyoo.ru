...
var $;
(function ($) {
    class $hyoo_invest_stock extends $.$mol_store {
        title(next) {
            var _a;
            return (_a = this.value('title', next)) !== null && _a !== void 0 ? _a : '';
        }
        enter_date(next) {
        ...
        enter_amount(next) {
            ...
            return (_a = this.value('enter_amount', next)) !== null && _a !== void 0 ? _a : 0;
        }
        exit_amount(next) {
        ...
        rate_annual(next) {
            ...
            if (exit_amount) {
                rate !== null && rate !== void 0 ? rate : (rate = (exit_amount - this.value('enter_amount')) / this.duration() / this.enter_amount() * 100);
            }
            return rate !== null && rate !== void 0 ? rate : 0;
        }
        interval() {
    ...
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock.prototype, "exit_amount", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock.prototype, "rate_annual", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock.prototype, "interval", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock.prototype, "duration", null);
    $.$hyoo_invest_stock = $hyoo_invest_stock;
})($ || ($ = {}));
//stock.js.map
;
"use strict";
var $;
(function ($) {
    class $hyoo_invest_store extends $.$mol_store {
        stocks() {
            return this.value('stocks').map((stock, index) => this.stock(index));
        }
        stock(index) {
            var _a;
            return this.sub('stocks')
                .sub(index, new $.$hyoo_invest_stock((_a = this.value('stocks')[index]) !== null && _a !== void 0 ? _a : {}));
        }
        enter_amount() {
            return this.stocks().reduce((sum, stock) => sum + stock.enter_amount(), 0);
        }
        exit_amount() {
            return this.stocks().reduce((sum, stock) => sum + stock.exit_amount(), 0);
        }
        rate_annual() {
            const total_amount = this.enter_amount();
            const total_rate = this.stocks().reduce((sum, stock) => sum + stock.rate_annual() * stock.enter_amount() / total_amount, 0);
            return total_rate;
        }
        stock_drop(index) {
    ...
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_store.prototype, "stocks", null);
    __decorate([
        $.$mol_mem_key
    ], $hyoo_invest_store.prototype, "stock", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_store.prototype, "enter_amount", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_store.prototype, "exit_amount", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_store.prototype, "rate_annual", null);
    $.$hyoo_invest_store = $hyoo_invest_store;
})($ || ($ = {}));
//store.js.map
;
"use strict";
...
var $;
(function ($) {
    class $hyoo_invest_labeler extends $.$mol_labeler {
        attr() {
            return Object.assign(Object.assign({}, super.attr()), { hyoo_invest_labeler_mood: this.mood() });
        }
        mood() {
            return "";
        }
    }
    $.$hyoo_invest_labeler = $hyoo_invest_labeler;
})($ || ($ = {}));
//labeler.view.tree.js.map
;
"use strict";
...
(function ($) {
    class $hyoo_invest_stock_row extends $.$mol_row {
        ...
        Rate() {
            ...
            obj.value = (val) => this.rate_annual(val);
            obj.enabled = () => this.enabled();
            return obj;
        }
        Rate_block() {
        ...
        Enter_amount() {
            const obj = new this.$.$mol_number();
            obj.value = (val) => this.enter_amount(val);
            obj.enabled = () => this.enabled();
            return obj;
        }
        Enter_amount_block() {
        ...
        Enter_date() {
            ...
            obj.value_moment = (val) => this.enter_date(val);
            obj.enabled = () => this.enabled();
            return obj;
        }
        Enter_date_block() {
        ...
        Exit_amount() {
            const obj = new this.$.$mol_number();
            obj.value = (val) => this.exit_amount(val);
            obj.enabled = () => this.enabled();
            return obj;
        }
        Exit_amount_block() {
        ...
        Exit_date() {
            const obj = new this.$.$mol_date();
            obj.value_moment = (val) => this.exit_date(val);
            obj.enabled = () => this.enabled();
            return obj;
        }
        Exit_date_block() {
    ...
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "stock", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "Tools", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "title", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "Title", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "Title_block", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "rate_annual", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "Rate", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "Rate_block", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "Main", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "income", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "Income", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "Income_block", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "duration", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "Duration", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "Duration_block", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "Results", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "Info", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "enter_amount", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "Enter_amount", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "Enter_amount_block", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "enter_date", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "Enter_date", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "Enter_date_block", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "Enter", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "exit_amount", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "Exit_amount", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "Exit_amount_block", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "exit_date", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "Exit_date", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "Exit_date_block", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "Exit", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest_stock_row.prototype, "Metrics", null);
    $.$hyoo_invest_stock_row = $hyoo_invest_stock_row;
    class $hyoo_invest_stock_row_group extends $.$mol_view {
    }
    $.$hyoo_invest_stock_row_group = $hyoo_invest_stock_row_group;
})($ || ($ = {}));
//row.view.tree.js.map
;
"use strict";
...
(function ($) {
    var $$;
    (function ($$) {
        class $hyoo_invest_stock_row extends $.$hyoo_invest_stock_row {
            title(next) {
            ...
            exit_date_mood() {
                ...
                const exit = (_b = (_a = this.exit_date()) === null || _a === void 0 ? void 0 : _a.toString('YYYY-MM-DD')) !== null && _b !== void 0 ? _b : '';
...
(function ($) {
    class $hyoo_invest extends $.$mol_page {
        ...
        Stock_drop(id) {
            const obj = new this.$.$mol_button_minor();
            obj.click = (event) => this.stock_drop(id, event);
            obj.sub = () => [
    ...
    __decorate([
        $.$mol_mem
    ], $hyoo_invest.prototype, "store", null);
    __decorate([
        $.$mol_mem_key
    ], $hyoo_invest.prototype, "Stock_row", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest.prototype, "Stock_summary", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest.prototype, "Theme", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest.prototype, "Sources", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest.prototype, "Lights", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_invest.prototype, "Stock_list", null);
    __decorate([
        $.$mol_mem_key
    ], $hyoo_invest.prototype, "stock", null);
    __decorate([
        $.$mol_mem_key
    ], $hyoo_invest.prototype, "stock_drop", null);
    __decorate([
        $.$mol_mem_key
    ], $hyoo_invest.prototype, "Stock_drop_icon", null);
    __decorate([
        $.$mol_mem_key
    ], $hyoo_invest.prototype, "Stock_drop", null);
    __decorate([
    ...
    $.$hyoo_invest = $hyoo_invest;
})($ || ($ = {}));
//invest.view.tree.js.map
;
"use strict";
var $;
(function ($) {
...
(function ($) {
    var $$;
    (function ($$) {
        class $hyoo_invest extends $.$hyoo_invest {
            stock_list() {
            ...
            enter_date() {
                return this.store().stocks().reduce((min, stock) => {
                    const date = stock.enter_date().toString();
                    return (min && (date > min))
                        ? min
                        : date !== null && date !== void 0 ? date : min;
                }, '');
            }
            exit_date() {
        ...
        __decorate([
            $.$mol_mem
        ], $hyoo_invest.prototype, "stock_rows", null);
        __decorate([
            $.$mol_mem
        ], $hyoo_invest.prototype, "store", null);
        __decorate([
            $.$mol_mem
        ], $hyoo_invest.prototype, "enter_date", null);
        __decorate([
            $.$mol_mem
        ], $hyoo_invest.prototype, "exit_date", null);
        $$.$hyoo_invest = $hyoo_invest;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//invest.view.js.map
